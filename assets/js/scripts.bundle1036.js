...
KTUtil.ready(function() {
    ...
    // Init General Actions Offcanvas Panel
    if (typeof KTLayoutGeneralActions !== 'undefined') {
        KTLayoutGeneralActions.init('kt_general_actions');
    }
...
var KTLayoutGeneralActions = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_general_actions_close',
            toggleBy: 'kt_general_actions_toggle'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutGeneralActions;
}
